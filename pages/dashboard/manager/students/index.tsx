...
import { AddStudentRequest, Student, StudentResponse, StudentType, UpdateStudentRequest } from "../../../../app/model/student";
...
import { Paginator } from "../../../../app/model/api";
...
const Students = () => {
  ...
  const { data, total, loading, paginator, modifyDataSuccessTimes,
    setData, setTotal, setLoading, setPaginator, setModifyDataSuccessTimes } = useListEffect<
      Paginator,
      StudentResponse,
      Student
    >(studentService.getStudents.bind(studentService), "students", true)
